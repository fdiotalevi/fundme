...
contract('FundMe', function(accounts) {
  ...
  it("should not accept a contribution when closed", function() {
    return FundMe.deployed().then(function(instance) {
      return instance.contribute.sendTransaction({from: accounts[1], value: 100});
  ...
  it("can be opened only by the owner", function() {
    return FundMe.deployed().then(function(instance) {
      return instance.open.sendTransaction({from: web3.eth.accounts[1]});
    }).then(function(result) {
      assert(false, "should have thrown an exception");
    }).catch(function(error) {
      assert(error.toString().indexOf(" invalid opcode") > 0, "incorrect error message");
...
contract('FundMe', function(accounts) {
  ...
  it("cannot be opened again", function() {
    return FundMe.deployed().then(function(instance) {
      return instance.open.sendTransaction();
    }).then(function(result) {
      assert(false, "should have thrown an exception");
    }).catch(function(error) {
      assert(error.toString().indexOf(" invalid opcode") > 0, "incorrect error message");
  ...
  it("should accept and count a valid contribution", function() {
    return FundMe.deployed().then(function(instance) {
      instance.contribute.sendTransaction({from: accounts[1], value: web3.toWei(0.1, 'ether')});
      return instance.raised.call();
    }).then(function(raised) {
  ...
  it("can be closed only by the owner", function() {
    return FundMe.deployed().then(function(instance) {
      return instance.close.sendTransaction({from: web3.eth.accounts[1]});
    }).then(function(result) {
      assert(false, "should have thrown an exception");
    }).catch(function(error) {
      assert(error.toString().indexOf(" invalid opcode") > 0, "incorrect error message");
  ...
  it("can be closed", function() {
    ...
    return FundMe.deployed().then(function(instance) {
      return instance.close.sendTransaction();
    }).then(function(result) {
